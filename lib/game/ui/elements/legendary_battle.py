...
LB_THOR_LOVE_THUNDER_BATTLE = UIElement(name='LB_THOR_LOVE_THUNDER_BATTLE')
LB_THOR_LOVE_THUNDER_BATTLE.description = "Legendary battle : Thor Love and Thunder."
LB_THOR_LOVE_THUNDER_BATTLE.text_rect = Rect(0.009792958164742556, 0.23292433537832305, 0.21140586139054904, 0.30099858170063987)
LB_THOR_LOVE_THUNDER_BATTLE.button_rect = Rect(0.023905861390549024, 0.11827297315126335, 0.181163925906678, 0.2365071904479188)
LB_THOR_LOVE_THUNDER_BATTLE.text = "MARVEL STUDIOS' THOR: LOVE AND THUNDER"
LB_THOR_LOVE_THUNDER_BATTLE.text_threshold = 120
LB_THOR_LOVE_THUNDER_BATTLE.tesseract_resize_height = 256

LB_THOR_LOVE_THUNDER_BATTLE_TITLE = UIElement(name='LB_THOR_LOVE_THUNDER_BATTLE_TITLE')
LB_THOR_LOVE_THUNDER_BATTLE_TITLE.description = "Legendary battle : Thor Love and Thunder (title on top)."
LB_THOR_LOVE_THUNDER_BATTLE_TITLE.text_rect = Rect(0.2255187646163555, 0.10035869780328516, 0.5380187646163554, 0.18276436440398444)
LB_THOR_LOVE_THUNDER_BATTLE_TITLE.text = "NEW ASGARD'S DESTINY"
LB_THOR_LOVE_THUNDER_BATTLE_TITLE.text_threshold = 130
LB_THOR_LOVE_THUNDER_BATTLE_TITLE.available_characters = "NEW ASGARD'S DESTINY"