...
CLEAR_BUTTON = UIElement(name='CLEAR_BUTTON')
CLEAR_BUTTON.description = "Clear button."
CLEAR_BUTTON.text_rect = Rect(0.39283266129032257, 0.9281182795698925, 0.47751008064516126, 0.9639605734767025)
CLEAR_BUTTON.button_rect = Rect(0.39283266129032257, 0.9281182795698925, 0.47751008064516126, 0.9639605734767025)
CLEAR_BUTTON.text = "CLEAR"
CLEAR_BUTTON.text_threshold = 150
...
CLEAR_TICKET_NOTIFICATION = UIElement(name='CLEAR_TICKET_NOTIFICATION')
CLEAR_TICKET_NOTIFICATION.description = "Clear Ticket Notification"
CLEAR_TICKET_NOTIFICATION.text_rect = Rect(0.4291229838709677, 0.17901433691756286, 0.5722681451612902, 0.2542831541218638)
CLEAR_TICKET_NOTIFICATION.text = "CLEAR TICKET"
CLEAR_TICKET_NOTIFICATION.text_threshold = 150

CLEAR_TICKET_NOTIFICATION_X1 = UIElement(name='CLEAR_TICKET_NOTIFICATION_X1')
CLEAR_TICKET_NOTIFICATION_X1.description = "Clear Ticket Notification. X1 Button."
CLEAR_TICKET_NOTIFICATION_X1.text_rect = Rect(0.22952620967741935, 0.7238172043010753, 0.40694556451612895, 0.8134229390681003)
CLEAR_TICKET_NOTIFICATION_X1.button_rect = Rect(0.22952620967741935, 0.7238172043010753, 0.40694556451612895, 0.8134229390681003)
CLEAR_TICKET_NOTIFICATION_X1.text = "USE x1"
CLEAR_TICKET_NOTIFICATION_X1.text_threshold = 150

CLEAR_TICKET_NOTIFICATION_X10 = UIElement(name='CLEAR_TICKET_NOTIFICATION_X10')
CLEAR_TICKET_NOTIFICATION_X10.description = "Clear Ticket Notification. X10 Button."
CLEAR_TICKET_NOTIFICATION_X10.text_rect = Rect(0.4129939516129032, 0.7309856630824372, 0.5843649193548387, 0.8062544802867382)
CLEAR_TICKET_NOTIFICATION_X10.button_rect = Rect(0.4129939516129032, 0.7309856630824372, 0.5843649193548387, 0.8062544802867382)
CLEAR_TICKET_NOTIFICATION_X10.text = "USE UP TO 10"
CLEAR_TICKET_NOTIFICATION_X10.text_threshold = 150

CLEAR_TICKET_NOTIFICATION_CLOSE = UIElement(name='CLEAR_TICKET_NOTIFICATION')
CLEAR_TICKET_NOTIFICATION_CLOSE.description = "Clear Ticket Notification. Close Button."
CLEAR_TICKET_NOTIFICATION_CLOSE.text_rect = Rect(0.5924294354838708, 0.7238172043010753, 0.7658165322580645, 0.8134229390681003)
CLEAR_TICKET_NOTIFICATION_CLOSE.button_rect = Rect(0.5924294354838708, 0.7238172043010753, 0.7658165322580645, 0.8134229390681003)
CLEAR_TICKET_NOTIFICATION_CLOSE.text = "CLOSE"
CLEAR_TICKET_NOTIFICATION_CLOSE.text_threshold = 150

CLEAR_TICKET_USED_NOTIFICATION_CLOSE = UIElement(name='CLEAR_TICKET_USED_NOTIFICATION_CLOSE')
CLEAR_TICKET_USED_NOTIFICATION_CLOSE.description = "Clear Ticket Used Notification (Reward Summary). Close Button."
CLEAR_TICKET_USED_NOTIFICATION_CLOSE.text_rect = Rect(0.5964616935483871, 0.8922759856630824, 0.7779133064516128, 0.9782974910394263)
CLEAR_TICKET_USED_NOTIFICATION_CLOSE.button_rect = Rect(0.5964616935483871, 0.8922759856630824, 0.7779133064516128, 0.9782974910394263)
CLEAR_TICKET_USED_NOTIFICATION_CLOSE.text = "CLOSE"
CLEAR_TICKET_USED_NOTIFICATION_CLOSE.text_threshold = 150
...
SKIP_TAP_THE_SCREEN.text_rect = Rect(0.7799540828644119, 0.8991053169734149, 0.9331798893160248, 0.9599788079688631)
SKIP_TAP_THE_SCREEN.button_rect = Rect(0.7799540828644119, 0.8991053169734149, 0.9331798893160248, 0.9599788079688631)
...
ITEM_MAX_LIMIT_NOTIFICATION.text_rect = Rect(0.32834117963860565, 0.39779421465795906, 0.6690669860902183, 0.44792532488950465)
ITEM_MAX_LIMIT_NOTIFICATION.button_rect = Rect(0.5057605344773153, 0.7057424632231676, 0.6509218247998958, 0.7809391285704861)
ITEM_MAX_LIMIT_NOTIFICATION.text = "One of your items has reached its max limit."
ITEM_MAX_LIMIT_NOTIFICATION.text_threshold = 150
...
ALL_AVAILABLE_ENTRIES_USED = UIElement(name='ALL_AVAILABLE_ENTRIES_USED')
ALL_AVAILABLE_ENTRIES_USED.description = "All Available Entries Used Notification."
ALL_AVAILABLE_ENTRIES_USED.text_rect = Rect(0.39484879032258063, 0.469336917562724, 0.6085584677419356, 0.52668458781362)
ALL_AVAILABLE_ENTRIES_USED.button_rect = Rect(0.4250907258064515, 0.7023118279569892, 0.5662197580645162, 0.7847491039426523)
ALL_AVAILABLE_ENTRIES_USED.text = "All available entries used."
ALL_AVAILABLE_ENTRIES_USED.text_threshold = 140

INSUFFICIENT_MATERIALS_NOTIFICATION = UIElement(name='STORY_COMBINE_FRAGMENT_UI_INSUFFICIENT_MATERIALS_OK')
INSUFFICIENT_MATERIALS_NOTIFICATION.description = "Button to Combine Fragments - Insufficient Materials - OK Button"
INSUFFICIENT_MATERIALS_NOTIFICATION.text_rect = Rect(0.39890816025924297, 0.4514885820846691, 0.6005210634850494, 0.5410488778381207)
INSUFFICIENT_MATERIALS_NOTIFICATION.button_rect = Rect(0.4513275150979526, 0.7130046456847476, 0.5521339667108559, 0.7667408231368186)
INSUFFICIENT_MATERIALS_NOTIFICATION.text = "Insufficient Materials."
INSUFFICIENT_MATERIALS_NOTIFICATION.text_threshold = 120
