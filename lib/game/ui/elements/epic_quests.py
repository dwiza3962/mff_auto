...
EQ_PAGE_DRAG_FROM_PAGE2 = UIElement(name='EQ_PAGE_DRAG_FROM_PAGE2')
EQ_PAGE_DRAG_FROM_PAGE2.description = "Page of Epic Quests: drag position (left) to scroll the list."
EQ_PAGE_DRAG_FROM_PAGE2.button_rect = Rect(0.6146068548387096, 0.44066308243727603, 0.6488810483870968, 0.49442652329749104)

EQ_PAGE_DRAG_TO_PAGE2 = UIElement(name='EQ_PAGE_DRAG_TO_PAGE2')
EQ_PAGE_DRAG_TO_PAGE2.description = "Page of Epic Quests: drag position (left) to scroll the list."
EQ_PAGE_DRAG_TO_PAGE2.button_rect = Rect(0.4, 0.4299103942652329, 0.41, 0.49442652329749104)
...
EQ_FIRST_FAMILY.text_rect = Rect(0.6952520161290322, 0.7739964157706092, 0.9271068548387096, 0.8277598566308244)
EQ_FIRST_FAMILY.button_rect = Rect(0.7799294354838707, 0.3582258064516129, 0.9472681451612902, 0.6485483870967741)
...
EQ_DEADLY_ACCURACY = UIElement(name='EQ_DEADLY_ACCURACY')
EQ_DEADLY_ACCURACY.description = "Epic Quest: Dark Reign: Cutthroat Companions: Deadly Accuracy mission."
EQ_DEADLY_ACCURACY.text_rect = Rect(0.6302083333333334, 0.6907407407407408, 0.6614583333333334, 0.725)
EQ_DEADLY_ACCURACY.button_rect = Rect(0.5885416666666666, 0.375, 0.7015625, 0.6527777777777778)
EQ_DEADLY_ACCURACY.text = "DEADLY ACCURACY"
EQ_DEADLY_ACCURACY.text_threshold = 150
...
EQ_TRUE_EVOLUTION_STAGE_LABEL.text_rect = Rect(0.040034893648613526, 0.003621610924203637, 0.2134219904228071, 0.08244442245530718)
EQ_TRUE_EVOLUTION_STAGE_LABEL.text = "TRUE EVOLUTION"

EQ_HEROES_REUNITED_LABEL = UIElement(name='EQ_HEROES_REUNITED_LABEL')
EQ_HEROES_REUNITED_LABEL.description = "Epic Quest: The Fate of Mankind: Heroes Reunited stage button and text."
EQ_HEROES_REUNITED_LABEL.text_rect = Rect(0.040034893648613526, 0.003621610924203637, 0.2134219904228071, 0.08244442245530718)
EQ_HEROES_REUNITED_LABEL.button_rect = Rect(0.040034893648613526, 0.003621610924203637, 0.2134219904228071, 0.08244442245530718)
EQ_HEROES_REUNITED_LABEL.text = "HEROES REUNITED"
EQ_HEROES_REUNITED_LABEL.text_threshold = 120

EQ_HEROES_REUNITED_STAGE_1 = UIElement(name='EQ_HEROES_REUNITED_STAGE_1')
EQ_HEROES_REUNITED_STAGE_1.description = "Epic Quest: The Fate of Mankind: Heroes Reunited: Madness Ensues stage #1."
EQ_HEROES_REUNITED_STAGE_1.text_rect = Rect(0.33697916666666666, 0.6907407407407408, 0.3697916666666667, 0.725)
EQ_HEROES_REUNITED_STAGE_1.button_rect = Rect(0.2984375, 0.375, 0.4125, 0.6527777777777778)
EQ_HEROES_REUNITED_STAGE_1.text_threshold = 160
EQ_HEROES_REUNITED_STAGE_1.available_characters = "0123456789/"

EQ_HEROES_REUNITED_STAGE_2 = UIElement(name='EQ_HEROES_REUNITED_STAGE_2')
EQ_HEROES_REUNITED_STAGE_2.description = "Epic Quest: The Fate of Mankind: Heroes Reunited: Madness Ensues stage #2."
EQ_HEROES_REUNITED_STAGE_2.text_rect = Rect(0.6302083333333334, 0.6907407407407408, 0.6614583333333334, 0.725)
EQ_HEROES_REUNITED_STAGE_2.button_rect = Rect(0.5885416666666666, 0.375, 0.7015625, 0.6527777777777778)
EQ_HEROES_REUNITED_STAGE_2.text_threshold = 120
EQ_HEROES_REUNITED_STAGE_2.available_characters = "0123456789/"
...
EQ_RECLAIMED_MEMORY.text_rect = Rect(0.3746875, 0.8636021505376343, 0.49363911290322576, 0.9030286738351253)
EQ_RECLAIMED_MEMORY.button_rect = Rect(0.3988810483870968, 0.716648745519713, 0.46541330645161283, 0.8170071684587813)
...
EQ_INDUSTRIAL_COMPLEX.text_rect = Rect(0.3383971774193549, 0.6593010752688171, 0.47347782258064514, 0.716648745519713)
EQ_INDUSTRIAL_COMPLEX.button_rect = Rect(0.3383971774193549, 0.6593010752688171, 0.47347782258064514, 0.716648745519713)
...
EQ_DEVIANT_DIVERSION.text_rect = Rect(0.531945564516129, 0.6593010752688171, 0.6589616935483871, 0.716648745519713)
EQ_DEVIANT_DIVERSION.button_rect = Rect(0.531945564516129, 0.6593010752688171, 0.6589616935483871, 0.716648745519713)
EQ_DEVIANT_DIVERSION.text = "Deviant Diversion"
EQ_DEVIANT_DIVERSION.text_threshold = 120

EQ_BROKEN_HARMONY = UIElement(name='EQ_BROKEN_HARMONY')
EQ_BROKEN_HARMONY.description = "Epic Quest: The Fate of Mankind: BROKEN HARMONY Memory mission."
EQ_BROKEN_HARMONY.text_rect = Rect(0.5057358870967742, 0.8600179211469534, 0.6226713709677419, 0.9101971326164873)
EQ_BROKEN_HARMONY.button_rect = Rect(0.5258971774193548, 0.7023118279569892, 0.6045262096774193, 0.8313440860215051)
EQ_BROKEN_HARMONY.text = "BROKEN HARMONY"
EQ_BROKEN_HARMONY.text_threshold = 120

EQ_BROKEN_HARMONY_LABEL = UIElement(name='EQ_BROKEN_HARMONY_LABEL')
EQ_BROKEN_HARMONY_LABEL.description = "Epic Quest: The Fate of Mankind: BROKEN HARMONY Memory label."
EQ_BROKEN_HARMONY_LABEL.text_rect = Rect(0.04605846774193548, 0.014139784946236583, 0.21339717741935485, 0.07865591397849458)
EQ_BROKEN_HARMONY_LABEL.text = "BROKEN HARMONY"
EQ_BROKEN_HARMONY_LABEL.text_threshold = 120

EQ_SMALLER_HEADS_PREVAIL = UIElement(name='EQ_SMALLER_HEADS_PREVAIL')
EQ_SMALLER_HEADS_PREVAIL.description = "Epic Quest: The Fate of Mankind: Reclaimed Memory: Smaller Heads Prevail mission."
EQ_SMALLER_HEADS_PREVAIL.text_rect = Rect(0.3464616935483871, 0.644964157706093, 0.4674294354838709, 0.7274014336917562)
EQ_SMALLER_HEADS_PREVAIL.button_rect = Rect(0.3464616935483871, 0.644964157706093, 0.4674294354838709, 0.7274014336917562)
EQ_SMALLER_HEADS_PREVAIL.text = "SMALLER HEADS PREVAIL"
EQ_SMALLER_HEADS_PREVAIL.text_threshold = 120

EQ_BRAINS_VS_BLADES = UIElement(name='EQ_BRAINS_VS_BLADES')
EQ_BRAINS_VS_BLADES.description = "Epic Quest: The Fate of Mankind: Reclaimed Memory: Brains vs. Blades mission."
EQ_BRAINS_VS_BLADES.text_rect = Rect(0.531945564516129, 0.6593010752688171, 0.6589616935483871, 0.716648745519713)
EQ_BRAINS_VS_BLADES.button_rect = Rect(0.531945564516129, 0.6593010752688171, 0.6589616935483871, 0.716648745519713)
EQ_BRAINS_VS_BLADES.text = "Brains VS Blades"
EQ_BRAINS_VS_BLADES.text_threshold = 120