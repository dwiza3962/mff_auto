...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.story_team_label = QtWidgets.QLabel(self.settings_group)
        self.story_team_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.story_team_label.setObjectName("story_team_label")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.story_team_label)
        self.story_team_spin_box = QtWidgets.QSpinBox(self.settings_group)
        self.story_team_spin_box.setMinimum(1)
        self.story_team_spin_box.setMaximum(5)
        self.story_team_spin_box.setObjectName("story_team_spin_box")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.story_team_spin_box)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.handle_network_errors_label)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.handle_network_errors_checkbox)
        self.useClearTicketsLabel = QtWidgets.QLabel(self.settings_group)
        self.useClearTicketsLabel.setObjectName("useClearTicketsLabel")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.useClearTicketsLabel)
        self.use_clear_tickets_checkbox = QtWidgets.QCheckBox(self.settings_group)
        self.use_clear_tickets_checkbox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.use_clear_tickets_checkbox.setChecked(True)
        self.use_clear_tickets_checkbox.setObjectName("use_clear_tickets_checkbox")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.use_clear_tickets_checkbox)
        ...
        self.story_button = QtWidgets.QPushButton(self.quick_start_group)
        self.story_button.setMinimumSize(QtCore.QSize(120, 50))
        self.story_button.setObjectName("story_button")
        self.verticalLayout.addWidget(self.story_button)
...
"color: rgb(0, 0, 127);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.story_team_label.setToolTip(_translate("MainWindow", "Your in-game team number for PvP mode"))
        self.story_team_label.setText(_translate("MainWindow", "Story Team"))
        self.story_team_spin_box.setToolTip(_translate("MainWindow", "Your in-game team number for PvP mode"))
        ...
        self.useClearTicketsLabel.setText(_translate("MainWindow", "Use Clear Tickets"))
        self.use_clear_tickets_checkbox.setToolTip(_translate("MainWindow", "Should we use clear tickets to Complete missions (beta)"))
...
"Clear All Floors"))
        self.story_button.setText(_translate("MainWindow", "Story Auto:\n"
"Clear All"))
